...
export const CodeViewer: React.FC<CodeViewerProps> = React.memo(({ code, fileName, highlightLines }) => {
    ...
    return (
        <div className="flex flex-col h-full bg-zinc-950 font-mono text-sm relative group">
            <div className="flex-1 overflow-auto custom-scrollbar relative" ref={containerRef}>
                <div className="flex min-h-full">
                    {/* Gutter */}
                    <div className="bg-zinc-900 border-r border-zinc-800 text-right pr-3 pl-2 py-4 select-none text-zinc-500 w-12 flex-shrink-0 z-10 text-[13px] leading-[20px]">
                         ...
                         {highlightLines && (
                            <div className="absolute w-full pointer-events-none z-0"
                                style={{ 
                                    ...
                                    height: '20px', 
                                    backgroundColor: highlightLines.color === 'blue' ? 'rgba(59, 130, 246, 0.15)' : 'rgba(249, 115, 22, 0.15)', 
